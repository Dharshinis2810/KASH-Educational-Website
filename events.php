...
?>
  ...
  <nav class="side-navbar">
    ...
    <ul class="list-unstyled">
      ...
      <li class="sidebar-item"><a class="sidebar-link" href="camp.php" data-bs-toggle="collapse">
  ...
  <div class="page">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page"><a class="fw-light"
                href="eventpage.php">Events </a></li>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Events Details </h3>
              </div>
              <div class="card-body">
                <form class="form-horizontal" autocomplete="off" action="events.php" method="post">
                  <div class="row">
                    <label class="col-sm-3 form-label">Header </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="pname" id="pname" type="text"><small class="form-text">Title of
                        the event</small>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="pdes" id="pdes" type="text"><small class="form-text">Description
                        of the event </small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    <label class="col-sm-3 form-label">Place </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="iname" id="iname" type="text"><small class="form-text">Place of
                        the event </small>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="pdate" id="pdate" type="date"><small class="form-text">Event
                        Date</small>
                    </div>
                  </div>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      $num=rand(1,50);
      $id=$pname."$num";
      $q="insert into event values('$id','$pname','$pdes','$iname','$pdate')"; #original
      $q1="insert into event1 values('$id','$pname','$pdes','$iname','$pdate')"; #duplicate
      $r=@mysqli_query($dbc,$q); 
      $r1=@mysqli_query($dbc,$q1);
      if($r) {
        echo "<script type=\"text/javascript\">"."
        alert('Event Details got added'); "."
