  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Camp </li>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Blood Camp Details</h1>
        <div class="d-flex"><a class="btn btn-xs btn-dark py-1 m-1" href="campadd.php"><i
              class="fas fa-plus-square me-1"></i>Add</a>
          <a class="btn btn-xs btn-dark py-1 m-1" href="campdetails.php"><i class="fas fa-search me-1"></i>View</a>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <form method="post" action="campdelete.php">
                    <table class="table text-sm mb-0" style="border: 2px solid;" id="example">
                      ...
                      <td><input name="delete[]" type="checkbox" id="checkbox[]" value="'.$row['camp_id'].'">
                      </td>
                      ...
                      <td>'.$row['reason'].'</td>
                      <td>'.$row['contact'].'</td>    
                      <td><div class="d-flex"><input class="btn btn-xs btn-dark py-1 m-1" type="submit" value="Delete"
                      name="but_delete"></div></td>           
