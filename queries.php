  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Queries </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Student Query Corner</h1>
        <div class="d-flex">
          <a class="btn btn-xs btn-dark py-1 m-1" href="queryview.php"><i class="fas fa-search me-1"></i>View</a>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-header border-bottom">
              <h2 class="h5 fw-normal mb-0"><a class="card-collapse-link text-dark d-block" data-bs-toggle="collapse"
                  href="#updates-box" aria-expanded="true">Queries </a></h2>
            </div>
            <div class="card-body p-0">
              <div class="collapse show" id="updates-box" role="tabpanel">
                ...
                <ul class="list-unstyled">
                  ...
                  <?php
                      echo '<form method="post" class="form-horizontal" autocomplete="off" action="reply1.php"> ';
              ...
              { ?>
                  ...
                  <div class="p-3 d-flex justify-content-between">
                    <div class="d-flex"><i class="fas fa-file text-gray-600"></i>
                      <div class="ms-3">
                        <input name="delete[]" type="checkbox" id="checkbox[]" value="<?= $row['qid'] ?>">
                        <h5 class="fw-bold h4 text-black-600 mb-1"><?= $row['user_name'] ?></h5>
                        <div class="row">
                          <p class="mb-0 text-gray-600"><?= $row['qmessage'] ?></p>
                          <div class="col-sm-9">
                            <input class="form-control" name="q1message" id="q1message" type="text"><small
                              class="form-text">Enter the message
                            </small>
                          </div>
                        </div>

                        <div class="d-flex"><input class="btn btn-xs btn-dark py-1 m-1" type="submit" value="Send"
                            name="but_delete"></div>
                      </div>
                    </div>
                  </div>
