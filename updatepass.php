  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Update Password </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Student Password - Update</h1>
      </div>
    </header>
    <?php
    require_once('connect.php');
    ...
    $q="update student1 set password='$password' where user_id='$user_id'";
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Password Update </h3>
              </div>
              <div class="card-body">
                <form class="form-horizontal" action="updatepass.php" autocomplete="off" method="post">
                  <div class="row">
                    <label class="col-sm-3 form-label">User ID </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="user_id" id="user_id" type="text"><small class="form-text">Enter
                        the user id</small>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="password" id="password" type="text"><small
