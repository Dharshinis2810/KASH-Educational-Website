  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Eligible Donors </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Donor Details</h1>
        <div class="d-flex"><a class="btn btn-xs btn-dark py-1 m-1" href="donoradd.php"><i
              class="fas fa-plus-square me-1"></i>Add</a><a class="btn btn-xs btn-dark py-1 m-1"
            href="bloodcount.php"><i class="fas fa-plus-square me-1"></i>Update Count</a>
          <a class="btn btn-xs btn-dark py-1 m-1" href="donoreligible.php"><i
              class="fas fa-plus-square me-1"></i>Eligible Donors</a>
        </div>
      </div>
    </header>
                      ...
                      <?php 
                        ...
                        if($num>0)
                        {
                          while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                          {
                            ...
                            $your_date = strtotime($row['lastdate']);
                            $datediff = $now - $your_date;
                            
                            $n=round($datediff / (60 * 60 * 24));
