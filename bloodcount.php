      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Update Count </li>
          </ol>
        </nav>
      </div>
    </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Donors Count Updation</h3>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <form action="count.php" autocomplete="off" method="post">
                    ...
                    <table class="table text-sm mb-0" style="border: 2px solid;" id="example">
                      ...
                      <tbody>
                        ...
                        if($num>0)
                        {
                          ...
                          {echo'
                        <tr>
                        <th rowspan="2"><input name="delete[]" type="checkbox" id="checkbox[]" value="'.$row['user_id'].'">
                        </th>
                        <th rowspan="2" scope="row">'.$id.'</th>
                        <td rowspan="2">'.$row['user_id'].'</td>
                        <td rowspan="2">'.$row['first_name'].$row['last_name'].'</td>
                        <td rowspan="2">'.$row['age'].'</td>
                        <td rowspan="2">'.$row['blood_group'].'</td>
                        <td rowspan="2">'.$row['phone'].'</td>
                        <td>'.$row['count'].'</td>
                        <td>'.$row['lastdate'].'</td>
                        <td rowspan="2">
                          <div class="d-flex"><input class="btn btn-xs btn-dark py-1 m-1" type="submit" value="Update"
                              name="but_delete"></div>
                        ...
                        <tr>
                          ...
                          <td><input class="form-control" name="count1" id="count1" type="text"></td>
                          <td> <input class="form-control" name="bdate1" id="bdate1" type="date"></td></tr>'; $id++;
                          }
                          }
                          mysqli_close($dbc);?>
