  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Programs </li>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Program Details</h1>
        <div class="d-flex"><a class="btn btn-xs btn-dark py-1 m-1" href="studentupdate.php"><i
              class="fas fa-plus-square me-1"></i>Add</a>
          <a class="btn btn-xs btn-dark py-1 m-1" href="programdetails.php"><i class="fas fa-search me-1"></i>View</a>
        </div>
      </div>
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h2 class="h5 fw-normal mb-0"><a class="card-collapse-link text-dark d-block" data-bs-toggle="collapse"
                    href="#updates-box" aria-expanded="true">Programs </a></h2>
              </div>
              <div class="card-body p-0">
                <div class="collapse show" id="updates-box" role="tabpanel">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <?php
                      echo '<form method="post" action="programdelete.php"> ';
              ...
              { ?>
                    ...
                    <div class="p-3 d-flex justify-content-between">
                      <div class="d-flex"><i class="fas fa-file text-gray-600"></i>
                        <div class="ms-3">
                          <input name="delete[]" type="checkbox" id="checkbox[]" value="<?= $row['id'] ?>">
                          <h5 class="fw-bold h4 text-black-600 mb-1"><?= $row['pname'] ?></h5>
                          <p class="mb-0 text-gray-600"><?= $row['pdesc'] ?></p>
                          <p class="mb-0 text-gray-600"><?= $row['ins'] ?> </p>
                          <div class="d-flex"><input class="btn btn-xs btn-dark py-1 m-1" type="submit" value="Delete"
                              name="but_delete"></div>
                        </div>
                      </div>
                      <div class="text-end ms-2"><strong
                          class="d-block lh-1 h2 mb-0 text-gray-500 fw-bold"><?= $row['pdate'] ?></strong></div>
