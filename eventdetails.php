          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Event Details</h3>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <form action="eventupdate.php" autocomplete="off" method="post">
                    ...
                    <table class="table text-sm mb-0" style="border: 2px solid;" id="example">
                      ...
                      <tbody>
                        ...
                        if($num>0)
                        {
                          ...
                          {echo'
                        <tr>
                        <th rowspan="2"><input name="delete[]" type="checkbox" id="checkbox[]" value="'.$row['eid'].'">
                        </th>
                        <th rowspan="2" scope="row">'.$id.'</th>
                        <td rowspan="2">'.$row['eid'].'</td>
                        <td>'.$row['eheader'].'</td>
                        <td>'.$row['edesc'].'</td>
                        <td>'.$row['eplace'].'</td>
                        <td>'.$row['edate'].'</td>
                        ...
                        <tr>
                          ...
                          <td><input class="form-control" name="p1name" id="p1name" type="text"></td>
                          <td><input class="form-control" name="p1des" id="p1des" type="text"></td>
                          <td><input class="form-control" name="i1name" id="i1name" type="text"></td>
                          <td> <input class="form-control" name="p1date" id="p1date" type="date"></td></tr>'; $id++;
                          }
                          }
                          mysqli_close($dbc);?>
