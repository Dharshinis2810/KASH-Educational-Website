...
?>
  ...
  <div class="page">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Send your Queries </h3>
              </div>
              <div class="card-body">
                <form class="form-horizontal" autocomplete="off" action="studentqueries.php" method="post">
                  <div class="row">
                    <label class="col-sm-3 form-label">Message </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="pmessage" id="pmessage" type="text"><small
                        class="form-text">Enter the
                        Queries you have</small>
                    </div>
                  </div>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      $num=rand(1,1000);
      $id=$name."$num";
      $q="insert into queries values('$id','$n3','$name','$pmessage')"; #original
      $r=@mysqli_query($dbc,$q); 
      if($r) {
        echo "<script type=\"text/javascript\">"."
        alert('Your Query will get report back in 3 Days'); "."
        </script>;";
      }
      else
      {
