  ...
  <div class="page">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page"><a class="fw-light"
                href="blooddonor.php">Donor </a></li>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Blood Donors</h1>
      </div>
    </header>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Blood Donor Details </h3>
              </div>
              <div class="card-body">
                <form class="form-horizontal" autocomplete="off" action="donoradd.php" method="post">
                  <div class="row">
                    <label class="col-sm-3 form-label">First Name </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="fname" id="fname" type="text"><small class="form-text">First
                        Name of the Donor</small>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="lname" id="lname" type="text"><small class="form-text">Last Name
                        of the Donor </small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="age" id="age" type="date"><small class="form-text">Age of
                        the Donor </small>
                    </div>
                  </div>
                  ...
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    <label class="col-sm-3 form-label">Blood Group </label>
                    <div class="col-sm-9">

                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="O+ve">
                        <label class="form-check-label" for="defaultRadio0">O<sup>+</sup></label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="O-ve">
                        <label class="form-check-label" for="defaultRadio0">O<sup>-</sup></label>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="A+ve">
                        <label class="form-check-label" for="defaultRadio0">A<sup>+</sup></label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="A-ve">
                        <label class="form-check-label" for="defaultRadio0">A<sup>-</sup></label>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="B+ve">
                        <label class="form-check-label" for="defaultRadio0">B<sup>+</sup></label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="B-ve">
                        <label class="form-check-label" for="defaultRadio0">B<sup>-</sup></label>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="AB+ve">
                        <label class="form-check-label" for="defaultRadio0">AB<sup>+</sup></label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" id="defaultRadio0" type="radio" name="radio" value="AB-ve">
                        <label class="form-check-label" for="defaultRadio0">AB<sup>-</sup></label>
                  ...
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    <label class="col-sm-3 form-label">Email Address </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="email" type="text"><small class="form-text">Mail Address of
                        the Donor</small>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                        <input class="form-control" name="phone" type="text"><small class="form-text">Phone Number of
                          the Donor</small>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">
                          Address </label>
                        <div class="col-sm-9">
                          <input class="form-control" name="address" type="text"><small class="form-text">Address of
                            the Donor</small>
                        </div>
                        <div class="border-bottom my-5 border-gray-200"></div>
                        <div class="row">
                          <label class="col-sm-3 form-label">
                            Count </label>
                          <div class="col-sm-9">
                            <input class="form-control" name="count" type="text"><small class="form-text">Count of
                              Donation</small>
                          </div>
                          <div class="border-bottom my-5 border-gray-200"></div>
                          <div class="row">
                            <label class="col-sm-3 form-label">
                              Last Donated Blood </label>
                            <div class="col-sm-9">
                              <input class="form-control" name="date1" type="date"><small class="form-text">Last Blood
                                Donated Date</small>
                            </div>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      $num=rand(1,50);
      $id=$fname."$num";
      $q="insert into blooddonor values('$id','$fname','$lname','$age','$radio','$email','$phone','$address','$count','$date1')"; #original
      $r=@mysqli_query($dbc,$q); 
      if($r) {
        echo "<script type=\"text/javascript\">"."
        alert('Details got added'); "."
