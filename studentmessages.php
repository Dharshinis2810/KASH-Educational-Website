  ...
  <div class="page">
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Queries Section</h1>
      </div>
    </header>
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h2 class="h5 fw-normal mb-0"><a class="card-collapse-link text-dark d-block" data-bs-toggle="collapse"
                    href="#feeds-box" aria-expanded="true">Reply Section
                  </a></h2>
              </div>
...
$query="select * from replyqueries1 where user_id='$_SESSION[user_id]'";
...
{ ?>
                    ...
                    <div class="p-3 border-bottom border-gray-200">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"></a>
                          <div class="ms-3">
                            <input name="delete[]" type="checkbox" id="checkbox[]" value="<?= $row['qid'] ?>">
                            <h5 class="fw-bold h5 text-black-400 mb-1"><?= $row['user_name'] ?></h5>
                            <h5 class="mb-0 text-gray-600">Your Query : <?= $row['qmessage'] ?></h6>
                              <h5 class="mb-0 text-gray-600">ADMIN : <?= $row['adminmessage'] ?></h6>

                                <div class="d-flex"><input class="btn btn-xs btn-dark py-1 m-1" type="submit"
                                    value="Delete" name="but_delete"></div>
                          </div>
                        </div>
                      </div>
                    </div>
