      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            <li class="breadcrumb-item"><a class="fw-light" href="studentprofile.php">Home</a></li>
            <li class="breadcrumb-item active fw-light" aria-current="page">Program </li>
                    ...
                    <div class="p-3 d-flex justify-content-between">
                      <div class="d-flex"><i class="fas fa-file text-gray-600"></i>
                        <div class="ms-3">
                          ...
                          <p class="mb-0 text-gray-600">Contact : <?= $row['contact'] ?> for queries</p>
                          <p class="mb-0 text-gray-600"><a><?= $row['url'] ?></a> </p>
                          <p class="mb-0 text-gray-600">Date : <?= $row['pdate'] ?> </p>
                          <p class="mb-0 text-gray-600">Time : <?= $row['ptime'] ?> </p>
                        </div>
                      </div>
