  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page"><a class="fw-light" href="camp.php">Camp
              </a></li>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Events</h1>
      </div>
    </header>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Camp Details </h3>
              </div>
              <div class="card-body">
                <form class="form-horizontal" autocomplete="off" action="campadd.php" method="post">
                  <div class="row">
                    <label class="col-sm-3 form-label">Camp Conducting Place </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="pname" id="pname" type="text"><small class="form-text">Place
                        where the camp is going to happen</small>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="pdes" id="pdes" type="text"><small class="form-text">Mention any
                        particular blood group is needed or mention all</small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="iname" id="iname" type="text"><small class="form-text">Mention
                        of age of eligibility</small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    <label class="col-sm-3 form-label">Reason </label>
                    <div class="col-sm-9">
                      <input class="form-control" name="rea" id="rea" type="text"><small class="form-text">Mention any
                        reasons for why you are conducting this camp</small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="cdate" id="cdate" type="date"><small class="form-text">Camp
                        Date</small>
                    </div>
                  </div>
                  <div class="border-bottom my-5 border-gray-200"></div>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" name="con" id="con" type="text"><small class="form-text">Contact
                        Person Phone Number</small>
                    </div>
                  </div>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      $num=rand(1,50);
      $id="$num";
      $q="insert into bloodcamp values('$id','$place','$date','$blood','$age','$reason','$contact')"; #original     
      $q1="insert into bloodcamp1 values('$id','$place','$date','$blood','$age','$reason','$contact')";   
