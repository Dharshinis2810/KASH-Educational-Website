  ...
  <div class="page">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 py-3">
            ...
            <li class="breadcrumb-item active fw-light" aria-current="page">Student</li>
    ...
    <header class="py-4">
      <div class="container-fluid py-2">
        <h1 class="h3 fw-normal mb-0">Student Details</h1>
        <div class="d-flex"><a class="btn btn-xs btn-dark py-1 m-1" href="studentadd.php"><i
              class="fas fa-plus-square me-1"></i>Add</a><a class="btn btn-xs btn-dark py-1 m-1"
            href="updatepass.php"><i class="fas fa-plus-square me-1"></i>Update Password</a></div>
      </div>
    </header>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Student Details</h3>
              </div>
              <div class="card-body">
                    ...
                    <table class="table text-sm mb-0" style="border: 2px solid;" id="example">
                      ...
                      <tbody>
                        ...
                        if($num>0)
                        {
                          ...
                          {echo'
                        <tr>
                        <td><input name="delete[]" type="checkbox" id="checkbox[]" value="'.$row['user_id'].'">
                      </td>
                      <th scope="row">'.$id.'</th>
                      <td>'.$row['user_id'].'</td>
                      <td>'.$row['first'].'</td>
